...
function get_excerpt($university, $numwords = 50)
{
    $string = "";
    $url = "university" . intval($university->id) . "/" . e($university->slug);
    return $string;
}
...
function show_menu ()
{
    ...
    $menu .= "<li><a class='' href='" . site_url("page") . "'>Home</a></li>" . PHP_EOL;

    $menu .= "<li><a class='' href='" . site_url("university") . "'>University</a></li>" . PHP_EOL;
    // $menu .= "<li><a class='' href='" . site_url("about") . "'>About us</a></li>" . PHP_EOL;
    if (isset($userdata["loggedin"])) {
        $menu .= "<li><a class='' href='" . site_url("front_user/logout") . "'>Logout</a></li>" . PHP_EOL;
        $menu .= "<li><a class='' href='" . site_url("front_user/index") . "'>{$userdata["name"]}</a></li>" . PHP_EOL;
    }
    else {
        $menu .= "<li><a class='' href='" . site_url("login") . "'>Login</a></li>" . PHP_EOL;
        $menu .= "<li><a class='' href='" . site_url("register") . "'>Register</a></li>" . PHP_EOL;

    }
    $menu .= "<li><a class='' href='" . site_url("tutorial") . "'>Tutorial</a></li>" . PHP_EOL;
