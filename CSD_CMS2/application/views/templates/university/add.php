            ...
            <div class="form-group">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control " id="name" name="name" placeholder="University Name:" value="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control " id="address" name="address" placeholder="University Address:" value="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control " id="phone" name="phone" placeholder="University Phone:" value="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control " id="website" name="website" placeholder="University Logo:" value="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control " id="logo" name="logo" placeholder="University Logo:" value="">
                    </div>
                </div>
            </div>
            <div class="form-group">
