...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      ...
      <a class="btn btn-primary" href="<?php echo site_url("admin/record/approved");?>" role="button">Approved</a>
      <a class="btn btn-default" href="<?php echo site_url("admin/record/rejected");?>" role="button">Rejected</a>
  ...
  <table id="record-table" class="table table-striped table-bordered table-hover" width="100%">
      ...
      <tbody>
        ...
        <?php foreach($records as $record): ?>
          <tr>
              <td><?php echo anchor("admin/record/view/", $record["university"]); ?></td>
