    ...
    class University extends Frontend_controller {
        ...
        public function edit($id = null) {
            ...
            if ($loggedin) {
                ...
                $rules = $this->university_m->rules_edit;
                ...
                $this->data["rule"] = $this->form_validation->run();
        ...
        public function add()
        {
            ...
            if ($loggedin) {
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    $data["modified"] = $now;
                    $id = $this->university_m->save($data);
        ...
        {
            $data = array();
            $count = $this->db->count_all("university");
        ...
        public function unique_university_name()
        {

            $this->db->where("UniversityName", $this->input->post("name"));

            $university = $this->db->get("university")->result_array();

            if(count($university)) {
                $this->form_validation->set_message("unique_university_name", "%s already exists.");
                return false;
            }
